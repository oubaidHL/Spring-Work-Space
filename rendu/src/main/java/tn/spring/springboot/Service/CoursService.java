...
public class CoursService implements ICoursService {
    ...
    @Override
    public List<Integer> numWeeksCourseOfInstructorBySupport(Long numInstructor, Cours.Support support) {
        return coursRepository.findWeeksByInstructorAndSupport(numInstructor, support);
    }
